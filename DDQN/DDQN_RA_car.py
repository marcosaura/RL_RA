...
class DDQNAgent:
    ...
    #     #     self.actions_array[action_n][0] = actions_values_array[action_n]
    ...
    #     # if action == 1: print("jump right")
    #     # if action == 2: print("jump!")
    #     return action
...
agent = DDQNAgent(action_dim=12, save_directory=save_directory)
