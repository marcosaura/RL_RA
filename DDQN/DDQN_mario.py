...
class DQN_node(Node):
    ...
    def init_publishers(self):
        ...
        self.DQN_time_publisher = self.create_publisher(Float32, "/TUoM/DDQN/time",  10)
        self.DQN_episode_publisher = self.create_publisher(Float32, "/TUoM/DDQN/episode",  10)
        self.DQN_frame_publisher = self.create_publisher(Float32, "/TUoM/DDQN/frame_number",  10)

        self.DQN_cm_reward_publisher = self.create_publisher(Float32, "/TUoM/DDQN/cummulative_reward",  10)
        self.DQN_cm_cl_reward_publisher = self.create_publisher(Float32, "/TUoM/DDQN/cummulative_clipped_reward",  10)
        self.DQN_tot_reward_publisher = self.create_publisher(Float32, "/TUoM/DDQN/total_reward",  10)
        self.DQN_tot_cl_reward_publisher = self.create_publisher(Float32, "/TUoM/DDQN/total_clipped_reward",  10)
        ...
        for action_pub in range (8):
            self.DQN_action_rew_publisher = self.create_publisher(Float32, "/TUoM/DDQN/action_reward_" + str(action_pub),  10)
            self.DQN_action_sigma_publisher = self.create_publisher(Float32, "/TUoM/DDQN/action_sigma_" + str(action_pub),  10)
        ...
        for action_pub in range (8):
            self.DQN_action_rew_publisher = self.create_publisher(Float32, "/TUoM/DDQN/norm_action_reward_" + str(action_pub),  10)
            self.DQN_action_sigma_publisher = self.create_publisher(Float32, "/TUoM/DDQN/norm_action_sigma_" + str(action_pub),  10)
        ...
        self.DQN_action_RA_publisher = self.create_publisher(Float32, "/TUoM/DDQN/RA_action",  10)
        self.DQN_orientation_RA_publisher = self.create_publisher(Float32, "/TUoM/DDQN/RA_orientation",  10)
    ...
    def act(self, state):
        ...
        if self.double_dqn:
            ...
            for action_n in range(len(actions_values_array)): 
                ...
                miu = actions_values_array[action_n] + actions_values_array[action_n]*random.uniform(0, 1)/10
