...
class RingAttractor():
    ...
    def cue_integration(self, C, noise=0.0):
        ...
        x0 = self.generate_signal(C[0][0], C[0][1], C[0][2], noise=noise)
        x1 = self.generate_signal(C[1][0], C[1][1], C[1][2], noise=noise)
        x2 = self.generate_signal(C[2][0], C[2][1], C[2][2], noise=noise)
        x3 = self.generate_signal(C[3][0], C[3][1], C[3][2], noise=noise)
        x4 = self.generate_signal(C[4][0], C[4][1], C[4][2], noise=noise)
        x5 = self.generate_signal(C[5][0], C[5][1], C[5][2], noise=noise)
        x6 = self.generate_signal(C[6][0], C[6][1], C[6][2], noise=noise)
        x7 = self.generate_signal(C[7][0], C[7][1], C[7][2], noise=noise)
